...
export default function Form() {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="flex flex-col items-center p-4 rounded-md shadow-sm bg-slate-200 w-72">
        <h2 className="font-bold">Registrar Producto</h2>
